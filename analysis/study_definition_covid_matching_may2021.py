...
#Exclusion variables
    ...
    deceased=patients.with_death_recorded_in_primary_care(
        ...
        return_expectations={"incidence": 0.10, "date": {"earliest" : "2020-02-01", "latest": "2022-08-31"}},
        ),
    death_date=patients.with_death_recorded_in_primary_care(
        between = ["2020-02-01", "2022-08-31"],
        returning="date_of_death",
        date_format= "YYYY-MM-DD",
        return_expectations={"incidence": 0.10, "date": {"earliest" : "2018-02-01", "latest": "2022-08-31"}},
    ),
