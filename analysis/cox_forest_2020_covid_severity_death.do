...
cap log close
macro drop hr
log using ./logs/cox_forest_2020_covid_severity_death.log, replace t
cap file close tablecontent
file open tablecontent using ./output/cox_forest_2020_covid_severity_death.csv, write text replace
