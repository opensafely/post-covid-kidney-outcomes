...
cap log close
macro drop hr
log using ./logs/cca_events_stroke_2020.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cca_events_stroke_2020.csv, write text replace
file write tablecontent _tab ("COVID-19 cohort") _tab ("Matched contemporary population cohort") _n
