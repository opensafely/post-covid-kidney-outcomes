...
cap log close
macro drop hr
log using ./logs/cox_forest_2020_case_death.log, replace t
cap file close tablecontent
file open tablecontent using ./output/cox_forest_2020_case_death.csv, write text replace
...
qui stcox i.case i.ethnicity i.covid_vax i.urban i.bmi i.smoking i.ckd_stage i.aki_baseline i.cardiovascular i.diabetes i.hypertension i.immunosuppressed i.non_haem_cancer i.gp_consults i.admissions i.imd, strata(set_id)
est store a
qui stcox i.case##i.covid_vax i.ethnicity i.urban i.bmi i.smoking i.ckd_stage i.aki_baseline i.cardiovascular i.diabetes i.hypertension i.immunosuppressed i.non_haem_cancer i.gp_consults i.admissions i.imd, strata(set_id)
est store b
qui lrtest b a
local p = r(p)
lincom 1.case, eform
...
est store a
qui stcox i.case##i.wave i.covid_vax i.ethnicity i.urban i.bmi i.smoking i.ckd_stage i.aki_baseline i.cardiovascular i.diabetes i.hypertension i.immunosuppressed i.non_haem_cancer i.gp_consults i.admissions i.imd, strata(set_id)
est store b
qui lrtest b a
local p = r(p)
lincom 1.case, eform
