cap log close
log using ./logs/covid_potential_general_population_northeast, replace t
clear

import delimited ./output/input_potential_contemporary_general_population_northeast.csv, delimiter(comma) varnames(1) case(preserve) 
...
save ./output/potential_contemporary_general_population_northeast.dta, replace 
log close
