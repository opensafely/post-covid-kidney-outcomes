...
cap log close
macro drop hr
log using ./logs/descriptive_cca_asthma_ethnicity_severity_2020.log, replace t

cap file close tablecontent
file open tablecontent using ./output/descriptive_cca_asthma_ethnicity_severity_2020.csv, write text replace
file write tablecontent _tab ("Hospitalised COVID-19 (n(%))") _tab _tab _tab _tab _tab ("Non-hospitalised COVID_19 (n(%))") _tab _tab _tab _tab _tab _n
...
use ./output/analysis_asthma_complete_2020.dta, clear
replace covid_severity=2 if covid_severity==3
forvalues i=1/5 {
qui safecount if covid_severity==2 & ethnicity==`i'
local cases_`i' = round(r(N),5)
qui safecount if covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui sum follow_up_time_esrd if covid_severity==2 & ethnicity==`i', d
local cases_q2_`i' = r(p50)
local cases_q1_`i' = r(p25)
local cases_q3_`i' = r(p75)
qui sum follow_up_time_esrd if covid_severity==1 & ethnicity==`i', d
...
forvalues i=1/5 {
qui sum age if covid_severity==2 & ethnicity==`i', d
local cases_q2_`i' = r(p50)
local cases_q1_`i' = r(p25)
local cases_q3_`i' = r(p75)
qui sum age if covid_severity==1 & ethnicity==`i', d
local controls_q2_`i' = r(p50)
local controls_q1_`i' = r(p25)
local controls_q3_`i' = r(p75)
}
...
forvalues i=1/5 {
qui safecount if agegroup==`age' & covid_severity==2 & ethnicity==`i'
local cases_`age'_`i' = round(r(N),5)
local cases_`age'_pc_`i' = (`cases_`age'_`i''/`cases_`i'')*100
qui safecount if agegroup==`age' & covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if sex==`sex' & covid_severity==2 & ethnicity==`i'
local cases_`sex'_`i' = round(r(N),5)
local cases_`sex'_pc_`i' = (`cases_`sex'_`i''/`cases_`i'')*100
qui safecount if sex==`sex' & covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if imd==`imd' & covid_severity==2 & ethnicity==`i'
local cases_`imd'_`i' = round(r(N),5)
local cases_`imd'_pc_`i' = (`cases_`imd'_`i''/`cases_`i'')*100
qui safecount if imd==`imd' & covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if region==`region' & covid_severity==2 & ethnicity==`i'
local cases_`region'_`i' = round(r(N),5)
local cases_`region'_pc_`i' = (`cases_`region'_`i''/`cases_`i'')*100
qui safecount if region==`region' & covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if urban==`urban' & covid_severity==2 & ethnicity==`i'
local cases_`urban'_`i' = round(r(N),5)
local cases_`urban'_pc_`i' = (`cases_`urban'_`i''/`cases_`i'')*100
qui safecount if urban==`urban' & covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if bmi==`bmi' & covid_severity==2 & ethnicity==`i'
local cases_`bmi'_`i' = round(r(N),5)
local cases_`bmi'_pc_`i' = (`cases_`bmi'_`i''/`cases_`i'')*100
qui safecount if bmi==`bmi' & covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if smoking==`smoking' & covid_severity==2 & ethnicity==`i'
local cases_`smoking'_`i' = round(r(N),5)
local cases_`smoking'_pc_`i' = (`cases_`smoking'_`i''/`cases_`i'')*100
qui safecount if smoking==`smoking' & covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui sum baseline_egfr if covid_severity==2 & ethnicity==`i', d
local cases_q2_`i' = r(p50)
local cases_q1_`i' = r(p25)
local cases_q3_`i' = r(p75)
qui sum baseline_egfr if covid_severity==1 & ethnicity==`i', d
local controls_q2_`i' = r(p50)
local controls_q1_`i' = r(p25)
local controls_q3_`i' = r(p75)
}
...
forvalues i=1/5 {
qui safecount if egfr_group==`group' & covid_severity==2 & ethnicity==`i'
local cases_`group'_`i' = round(r(N),5)
local cases_`group'_pc_`i' = (`cases_`group'_`i''/`cases_`i'')*100
qui safecount if egfr_group==`group' & covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if aki_baseline==1 & covid_severity==2 & ethnicity==`i'
local cases_aki_`i' = round(r(N),5)
local cases_aki_pc_`i' = (`cases_aki_`i''/`cases_`i'')*100
qui safecount if aki_baseline==1 & covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if cardiovascular==1 & covid_severity==2 & ethnicity==`i'
local cases_cardiovascular_`i' = round(r(N),5)
local cases_cardiovascular_pc_`i' = (`cases_cardiovascular_`i''/`cases_`i'')*100
qui safecount if cardiovascular==1 & covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if diabetes==1 & covid_severity==2 & ethnicity==`i'
local cases_diabetes_`i' = round(r(N),5)
local cases_diabetes_pc_`i' = (`cases_diabetes_`i''/`cases_`i'')*100
qui safecount if diabetes==1 & covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if hypertension==1 & covid_severity==2 & ethnicity==`i'
local cases_hypertension_`i' = round(r(N),5)
local cases_hypertension_pc_`i' = (`cases_hypertension_`i''/`cases_`i'')*100
qui safecount if hypertension==1 & covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if immunosuppressed==1 & covid_severity==2 & ethnicity==`i'
local cases_immunosuppressed_`i' = round(r(N),5)
local cases_immunosuppressed_pc_`i' = (`cases_immunosuppressed_`i''/`cases_`i'')*100
qui safecount if immunosuppressed==1 & covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if non_haem_cancer==1 & covid_severity==2 & ethnicity==`i'
local cases_non_haem_cancer_`i' = round(r(N),5)
local cases_non_haem_cancer_pc_`i' = (`cases_non_haem_cancer_`i''/`cases_`i'')*100
qui safecount if non_haem_cancer==1 & covid_severity==1 & ethnicity==`i'
...
qui safecount if covid_covariate==1 & covid_severity==2
forvalues i=1/5 {
qui safecount if covid_covariate==1 & covid_severity==2 & ethnicity==`i'
local cases_covid_covariate_`i' = round(r(N),5)
local cases_covid_covariate_pc_`i' = (`cases_covid_covariate_`i''/`cases_`i'')*100
qui safecount if covid_covariate==1 & covid_severity==1 & ethnicity==`i'
...
forvalues i=1/5 {
qui sum gp_count if covid_severity==2 & ethnicity==`i', d
local cases_q2_`i' = r(p50)
local cases_q1_`i' = r(p25)
local cases_q3_`i' = r(p75)
qui sum gp_count if covid_severity==1 & ethnicity==`i', d
local controls_q2_`i' = r(p50)
local controls_q1_`i' = r(p25)
local controls_q3_`i' = r(p75)
}
...
file write tablecontent ("`label_`group''") _tab
forvalues i=1/5 {
qui safecount if admissions==`group' & covid_severity==2 & ethnicity==`i'
local cases_`group'_`i' = round(r(N),5)
local cases_`group'_pc_`i' = (`cases_`group'_`i''/`cases_`i'')*100
qui safecount if admissions==`group' & covid_severity==1 & ethnicity==`i'
local controls_`group'_`i' = round(r(N),5)
local controls_`group'_pc_`i' = (`controls_`group'_`i''/`controls_`i'')*100
}
forvalues i=1/5 {
...
forvalues i=1/5 {
qui safecount if wave==`wave' & covid_severity==2 & ethnicity==`i'
local cases_`wave'_`i' = round(r(N),5)
local cases_`wave'_pc_`i' = (`cases_`wave'_`i''/`cases_`i'')*100
qui safecount if wave==`wave' & covid_severity==1 & ethnicity==`i'
