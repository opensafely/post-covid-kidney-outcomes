...
#Note:
# - Variables will be extracted at covid_diagnosis_date (in study_definition_covid_all_for_matching)
...
study = StudyDefinition(
    ...
    baseline_creatinine=patients.most_recent_creatinine(
        on_or_before="covid_diagnosis_date - 14 days" 
            #I.e. 14 days before covid_diagnosis_date from study_definition_covid_all_for_matching
    ...
    #Excluding anyone who died before patient_index_date 
        #(i.e. within 28 days after covid_diagnosis_date)
