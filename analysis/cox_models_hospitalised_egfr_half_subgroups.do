...
cap log close
macro drop hr
log using ./logs/cox_models_hospitalised_egfr_half_subgroups.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cox_models_hospitalised_egfr_half_subgroups.csv, write text replace
...
foreach var of varlist critical_care adm_aki {

forvalues j=0/1 {
use ./output/analysis_hospitalised.dta, clear
local `var'`j': label `var' `j'
file write tablecontent ("``var'`j''") _n
