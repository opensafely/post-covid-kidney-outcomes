...
local month_year "feb2017 mar2017 apr2017 may2017 jun2017 jul2017 aug2017 sep2017 oct2017 nov2017 dec2017 jan2018 feb2018 mar2018 apr2018 may2018 jun2018 jul2018 aug2018 sep2018 oct2018 nov2018 dec2018 jan2019 feb2019 mar2019 apr2019 may2019 jun2019 jul2019 aug2019 sep2019 feb2020 mar2020 apr2020 may2020 jun2020 jul2020 aug2020 sep2020 oct2020 nov2020 dec2020 jan2021 feb2021 mar2021 apr2021 may2021 jun2021 jul2021 aug2021 sep2021 oct2021 nov2021 dec2021 jan2022 feb2022 mar2022 apr2022 may2022 jun2022 jul2022 aug2022 sep2022"
foreach x of local month_year {
  replace egfr50%_date=date("15`x'", "DMY") if baseline_egfr!=. & egfr50%_date==.& egfr_creatinine_`x'<0.5*baseline_egfr & date("01`x'", "DMY")>=index_date
  format egfr50%_date %td
}
replace egfr50%_date=esrd_date if egfr50%_date==.
* Index date (50% eGFR reduction)
gen index_date_egfr50% = index_date
replace index_date_egfr50% =. if baseline_egfr==.
* Exit date (50% eGFR reduction)
gen exit_date_egfr50% = egfr50%_date
format exit_date_egfr50% %td
replace exit_date_egfr50% = min(deregistered_date,death_date,end_date) if egfr50%_date==. & index_date_egfr50%!=.
gen follow_up_time_egfr50% = (exit_date_egfr50% - index_date_egfr50%)
label var follow_up_time_egfr50% "Follow-up time (50% eGFR reduction) (Days)"
...
foreach exposure of varlist	case			///
	...
	est store B
	lrtest B A
	stcox i.`exposure' i.sex i.ethnicity i.imd i.region i.stp i.urbanicity i.bmi i.smoking age1 age2 age3, vce(cluster practice_id)
	stcox i.`exposure' i.sex i.ethnicity i.imd i.region i.stp i.urbanicity i.bmi i.smoking age1 age2 age3
	est store A
	quietly stcox i.sex i.ethnicity i.imd i.region i.stp i.urbanicity i.bmi i.smoking age1 age2 age3
	est store B
	lrtest B AKI
	}

* 50% eGFR reduction
stset exit_date_egfr50%, fail(egfr50%_date) origin(index_date_egfr50%) id(patient_id) scale(365.25)
foreach exposure of varlist	case			///
							covid_severity 	///
							covid_aki 		///
							covid_krt		///
