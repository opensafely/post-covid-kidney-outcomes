...
cap log close
macro drop hr
log using ./logs/cox_models2_2017_death.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cox_models2_2017_death.csv, write text replace
...
stset exit_date`x'_death, fail(death_date`x') origin(index_date_death) id(unique) scale(365.25)
