...
# t1
t1 <- structure(list(
  hr      = c(NA, 1.00, 2.56, 1.51, 1.21, 1.27), 
  lower   = c(NA, 1.00, 2.18, 1.40, 1.08, 1.13),
  upper   = c(NA, 1.00, 3.01, 1.64, 1.36, 1.43),
  number  = c(NA, 10399825, 108275, 1054695, 1042910, 1349535),
  nevents = c("", "7495", "630", "1710", "705", "830"),
  rate   = c(NA, 59, 264, 92, 61, 78)),
...
tabletext <- cbind(c("ESRD", rownames), 
