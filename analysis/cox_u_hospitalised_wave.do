...
file write tablecontent ("4. Fully adjusted: additionally adjusted for cardiovascular diseases, diabetes, hypertension, immunocompromise, cancer and number of GP interactions") _n
file write tablecontent _n
...
stcox i.wave i.sex i.ethnicity i.imd i.region i.urban i.bmi i.cardiovascular i.diabetes i.hypertension i.immunosuppressed i.non_haem_cancer i.smoking i.gp_consults age1 age2 age3 i.month, vce(cluster practice_id)		
matrix table = r(table)
