...
cap log close
macro drop hr
log using ./logs/cox_models_case_aki_hospitalised.log, replace t
cap file close tablecontent
file open tablecontent using ./output/cox_models_case_aki_hospitalised.csv, write text replace
