...
cap log close
macro drop hr
log using ./logs/cox_models2_2017_egfr_half.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cox_models2_2017_egfr_half.csv, write text replace
...
stset exit_date`x'_egfr_half, fail(egfr_half_date`x') origin(index_date_egfr_half) id(unique) scale(365.25)
...
local crude_wave_1ul`x': display %4.2f table[6,2]
local crude_wave_2b`x': display %4.2f table[1,3]
local crude_wave_2ll`x': display %4.2f table[5,3]
local crude_wave_2ul`x': display %4.2f table[6,3]
local crude_wave_3b`x': display %4.2f table[1,4]
local crude_wave_3ll`x': display %4.2f table[5,4]
local crude_wave_3ul`x': display %4.2f table[6,4]
local crude_wave_4b`x': display %4.2f table[1,5]
...
local crude_vax_1ul`x': display %4.2f table[6,2]
local crude_vax_2b`x': display %4.2f table[1,3]
local crude_vax_2ll`x': display %4.2f table[5,3]
local crude_vax_2ul`x': display %4.2f table[6,3]
local crude_vax_3b`x': display %4.2f table[1,4]
local crude_vax_3ll`x': display %4.2f table[5,4]
local crude_vax_3ul`x': display %4.2f table[6,4]
local crude_vax_4b`x': display %4.2f table[1,5]
local crude_vax_4ll`x': display %4.2f table[5,5]
local crude_vax_4ul`x': display %4.2f table[6,5]
local crude_vax_5b`x': display %4.2f table[1,6]
