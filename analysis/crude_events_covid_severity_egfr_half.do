...
cap log close
macro drop hr
log using ./logs/crude_events_covid_severity_egfr_half.log, replace t

cap file close tablecontent
file open tablecontent using ./output/crude_events_covid_severity_egfr_half.csv, write text replace
