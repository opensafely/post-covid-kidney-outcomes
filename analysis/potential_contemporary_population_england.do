cap log close
log using ./logs/potential_contemporary_population_england, replace t
clear

import delimited ./output/input_potential_contemporary_population_england.csv, delimiter(comma) varnames(1) case(preserve) 
...
save ./output/potential_contemporary_population_england.dta, replace 
log close
