...
capture log close
log using "logs/descriptive_hospitalised_case.log", replace t

* Open Stata dataset
use ./output/analysis_hospitalised, clear
...
file open tablecontent using ./output/descriptive_hospitalised_case.csv, write text replace
...
qui tabulatevariable, variable(stp) min(1) max(31)
file write tablecontent _n 
