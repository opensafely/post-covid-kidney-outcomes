...
cap log close
macro drop hr
log using ./logs/crude_events_covid_aki_esrd.log, replace t

cap file close tablecontent
file open tablecontent using ./output/crude_events_covid_aki_esrd.csv, write text replace
...
forvalues i=1/3 {
qui safecount if covid_aki==`i' & esrd==1
local cases_events_`i' = round(r(N),5)
}
qui safecount if covid_aki==0 & esrd==1
...
use ./output/analysis_`x'.dta, clear
forvalues i=1/3 {
qui safecount if agegroup==`age' & covid_aki==`i' & esrd==1
local cases_events_`i' = round(r(N),5)
}
qui safecount if agegroup==`age' & covid_aki==0 & esrd==1
local controls_events = round(r(N),5)
file write tablecontent _tab (`cases_events_1') _tab (`cases_events_2') _tab (`cases_events_3') _tab (`controls_events')
}
file write tablecontent _n
...
use ./output/analysis_`x'.dta, clear
forvalues i=1/3 {
qui safecount if sex==`sex' & covid_aki==`i' & esrd==1
local cases_events_`i' = round(r(N),5)
}
qui safecount if sex==`sex' & covid_aki==0 & esrd==1
local controls_events = round(r(N),5)
file write tablecontent _tab (`cases_events_1') _tab (`cases_events_2') _tab (`cases_events_3') _tab (`controls_events')
}
file write tablecontent _n
...
use ./output/analysis_`x'.dta, clear
forvalues i=1/3 {
qui safecount if imd==`imd' & covid_aki==`i' & esrd==1
local cases_events_`i' = round(r(N),5)
}
qui safecount if imd==`imd' & covid_aki==0 & esrd==1
local controls_events = round(r(N),5)
file write tablecontent _tab (`cases_events_1') _tab (`cases_events_2') _tab (`cases_events_3') _tab (`controls_events')
}
file write tablecontent _n
...
use ./output/analysis_`x'.dta, clear
forvalues i=1/3 {
qui safecount if ethnicity==`ethnicity' & covid_aki==`i' & esrd==1
local cases_events_`i' = round(r(N),5)
}
qui safecount if ethnicity==`ethnicity' & covid_aki==0 & esrd==1
local controls_events = round(r(N),5)
file write tablecontent _tab (`cases_events_1') _tab (`cases_events_2') _tab (`cases_events_3') _tab (`controls_events')
}
file write tablecontent _n
...
use ./output/analysis_`x'.dta, clear
forvalues i=1/3 {
qui safecount if ethnicity==. & covid_aki==`i' & esrd==1
local cases_events_`i' = round(r(N),5)
}
qui safecount if ethnicity==. & covid_aki==0 & esrd==1
local controls_events = round(r(N),5)
file write tablecontent _tab (`cases_events_1') _tab (`cases_events_2') _tab (`cases_events_3') _tab (`controls_events')
}
file write tablecontent _n
...
use ./output/analysis_`x'.dta, clear
forvalues i=1/3 {
qui safecount if egfr_group==`group' & covid_aki==`i' & esrd==1
local cases_events_`i' = round(r(N),5)
}
qui safecount if egfr_group==`group' & covid_aki==0 & esrd==1
local controls_events = round(r(N),5)
file write tablecontent _tab (`cases_events_1') _tab (`cases_events_2') _tab (`cases_events_3') _tab (`controls_events')
}
file write tablecontent _n
...
use ./output/analysis_`x'.dta, clear
forvalues i=1/3 {
qui safecount if aki_baseline==`aki' & covid_aki==`i' & esrd==1
local cases_events_`i' = round(r(N),5)
}
qui safecount if aki_baseline==`aki' & covid_aki==0 & esrd==1
local controls_events = round(r(N),5)
file write tablecontent _tab (`cases_events_1') _tab (`cases_events_2') _tab (`cases_events_3') _tab (`controls_events')
}
file write tablecontent _n
...
use ./output/analysis_`x'.dta, clear
forvalues i=1/3 {
qui safecount if diabetes==`diabetes' & covid_aki==`i' & esrd==1
local cases_events_`i' = round(r(N),5)
}
qui safecount if diabetes==`diabetes' & covid_aki==0 & esrd==1
local controls_events = round(r(N),5)
file write tablecontent _tab (`cases_events_1') _tab (`cases_events_2') _tab (`cases_events_3') _tab (`controls_events')
}
file write tablecontent _n
...
file write tablecontent ("`label_`group''")
forvalues i=1/3 {
qui safecount if covid_vax==`group' & covid_aki==`i' & esrd==1
local cases_events_`i' = round(r(N),5)
}
qui safecount if covid_vax==`group' & covid_aki==0 & esrd==1
local controls_events = round(r(N),5)
...
file write tablecontent ("`label_`group''")
forvalues i=1/3 {
qui safecount if wave==`group' & covid_aki==`i' & esrd==1
local cases_events_`i' = round(r(N),5)
}
qui safecount if wave==`group' & covid_aki==0 & esrd==1
local controls_events = round(r(N),5)
file write tablecontent _tab _tab _tab _tab _tab (`cases_events_1') _tab (`cases_events_2') _tab (`cases_events_3') _tab (`controls_events') _n
}
