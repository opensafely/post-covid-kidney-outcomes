...
cap log close
log using ./logs/analysis_pneumonia_2017.log, replace t
...
gen end_date = date("2020-01-31", "YMD")
format end_date %td
...
save ./output/analysis_pneumonia_2017.dta, replace
log close