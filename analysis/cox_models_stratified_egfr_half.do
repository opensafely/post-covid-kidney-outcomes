...
cap log close
macro drop hr
log using ./logs/cox_models_stratified_egfr_half.log, replace t
cap file close tablecontent
file open tablecontent using ./output/cox_models_stratified_egfr_half.csv, write text replace
