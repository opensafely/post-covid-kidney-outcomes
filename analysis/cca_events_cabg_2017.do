...
cap log close
macro drop hr
log using ./logs/cca_events_cabg_2017.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cca_events_cabg_2017.csv, write text replace
file write tablecontent _tab ("Coronary interventions cohort (pre-pandemic)") _tab ("Matched cohort") _n
