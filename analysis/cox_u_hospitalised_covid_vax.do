...
stcox i.covid_vax i.sex i.ethnicity i.imd i.region i.urban i.bmi i.cardiovascular i.diabetes i.hypertension i.immunosuppressed i.non_haem_cancer i.smoking i.gp_consults age1 age2 age3 i.month, vce(cluster practice_id)		
matrix table = r(table)
