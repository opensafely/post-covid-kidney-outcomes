...
cap log close
macro drop hr
log using ./logs/cox_forest_2017_egfr_half.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cox_forest_2017_egfr_half.csv, write text replace
...
file write tablecontent ("Overall") _tab ("`cases`i'_rate'") (" (") %3.2f (`cases`i'_ll')  ("-") %3.2f (`cases`i'_ul') (")") _tab ("`cases`i'_rate'")  _tab %4.2f (`full_severity_`i'b') (" (") %4.2f (`full_severity_`i'll') ("-") %4.2f (`full_severity_`i'ul') (")") _tab %4.2f (`full_severity_`i'b') _tab %4.2f (`full_severity_`i'll') _tab (`full_severity_`i'ul') _n
foreach x of local period {
file write tablecontent ("`lab`x''") _tab ("`cases`i'_rate`x''") (" (") %3.2f (`cases`i'_ll`x'')  ("-") %3.2f (`cases`i'_ul`x'') (")")  _tab ("`cases`i'_rate`x''") _tab %4.2f (`full_severity_`i'b`x'') (" (") %4.2f (`full_severity_`i'll`x'') ("-") %4.2f (`full_severity_`i'ul`x'') (")") _tab %4.2f (`full_severity_`i'b`x'') _tab %4.2f (`full_severity_`i'll`x'') _tab %4.2f (`full_severity_`i'ul`x'') _n
}
}
file write tablecontent _n
...
file write tablecontent ("Overall") _tab ("`cases`i'_rate'") (" (") %3.2f (`cases`i'_ll')  ("-") %3.2f (`cases`i'_ul') (")") _tab ("`cases`i'_rate'")  _tab %4.2f (`full_aki_`i'b') (" (") %4.2f (`full_aki_`i'll') ("-") %4.2f (`full_aki_`i'ul') (")") _tab %4.2f (`full_aki_`i'b') _tab %4.2f (`full_aki_`i'll') _tab (`full_aki_`i'ul') _n
foreach x of local period {
file write tablecontent ("`lab`x''") _tab ("`cases`i'_rate`x''") (" (") %3.2f (`cases`i'_ll`x'')  ("-") %3.2f (`cases`i'_ul`x'') (")")  _tab ("`cases`i'_rate`x''") _tab %4.2f (`full_aki_`i'b`x'') (" (") %4.2f (`full_aki_`i'll`x'') ("-") %4.2f (`full_aki_`i'ul`x'') (")") _tab %4.2f (`full_aki_`i'b`x'') _tab %4.2f (`full_aki_`i'll`x'') _tab %4.2f (`full_aki_`i'ul`x'') _n
}
}
file write tablecontent _n
