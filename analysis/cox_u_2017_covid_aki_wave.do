...
cap log close
macro drop hr
log using ./logs/cox_u_2017_covid_aki_wave.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cox_u_2017_covid_aki_wave.txt, write text replace
file write tablecontent ("Kidney outcomes by COVID-19 AKI compared to matched historical general population for each COVID-19 wave") _n
