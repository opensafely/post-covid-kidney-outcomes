cap log close
log using ./logs/covid_northeast, replace t
clear

import delimited ./output/input_covid_northeast.csv, delimiter(comma) varnames(1) case(preserve) 
...
save ./output/covid_northeast.dta, replace 
log close
