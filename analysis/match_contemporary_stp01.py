...
#Individuals extracted from study_definition_covid_stp01 will be matched to individuals from 
    #study_definition_contemporary_general_population_stp01
...
match(
    ...
    match_csv="contemporary_stp01_matching",
    matches_per_case=5,
    match_variables={
        "male": "category",
        "year_of_birth": 0,
