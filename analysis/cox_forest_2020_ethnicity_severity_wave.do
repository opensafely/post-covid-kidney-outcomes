...
cap log close
macro drop hr
log using ./logs/cox_forest_2020_ethnicity_severity_wave.log, replace t
cap file close tablecontent
file open tablecontent using ./output/cox_forest_2020_ethnicity_severity_wave.csv, write text replace
file write tablecontent ("ethnicity") _tab ("model") _tab ("wave") _tab ("severity") _tab ("HR (95% CI)") _tab ("hr") _tab ("ll") _tab ("ul") _tab ("p-value for interaction") _n

forvalues w=1/4 {

use ./output/analysis_complete_2020.dta, clear

local wave_`w': label wave `w'
drop if wave!=`w'
...
replace krt_date=. if covid_exit<krt_date&case==0
...
forvalues j=1/2 {
local severity_`j': label covid_severity `j'	
forvalues i=1/5 {
...
file write tablecontent ("``out'_lab'") _tab _tab _tab _tab _tab _tab _tab _tab (`p') _n
forvalues j=1/2 {
file write tablecontent ("`label_1'") _tab ("Conditional") _tab ("`wave_`w''") _tab ("`severity_`j''") _tab %4.2f (`int_`j'1b') (" (") %4.2f (`int_`j'1ll') ("-") %4.2f (`int_`j'1ul') (")") _tab %4.2f (`int_`j'1b') _tab %4.2f (`int_`j'1ll') _tab %4.2f (`int_`j'1ul') _n
forvalues i=2/5 {
file write tablecontent ("`label_`i''") _tab ("Conditional") _tab ("`wave_`w''") _tab ("`severity_`j''") _tab %4.2f (`int_`j'`i'b') (" (") %4.2f (`int_`j'`i'll') ("-") %4.2f (`int_`j'`i'ul') (")") _tab %4.2f (`int_`j'`i'b') _tab %4.2f (`int_`j'`i'll') _tab %4.2f (`int_`j'`i'ul') _n
}
}
drop age1 age2 age3
...
file write tablecontent ("``out'_lab'") _tab _tab _tab _tab _tab _tab _tab _tab (`p') _n
forvalues j=1/2 {
file write tablecontent ("`label_1'") _tab ("Frequency") _tab ("`wave_`w''") _tab ("`severity_`j''") _tab %4.2f (`int_`j'1b') (" (") %4.2f (`int_`j'1ll') ("-") %4.2f (`int_`j'1ul') (")") _tab %4.2f (`int_`j'1b') _tab %4.2f (`int_`j'1ll') _tab %4.2f (`int_`j'1ul') _n
forvalues i=2/5 {
