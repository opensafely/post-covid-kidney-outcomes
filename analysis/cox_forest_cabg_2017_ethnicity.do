...
cap log close
macro drop hr
log using ./logs/cox_forest_cabg_2017_ethnicity.log, replace t
cap file close tablecontent
file open tablecontent using ./output/cox_forest_cabg_2017_ethnicity.csv, write text replace
...
qui stcox i.case i.ethnicity i.imd i.urban i.bmi i.smoking i.ckd_stage i.aki_baseline i.cardiovascular i.diabetes i.hypertension i.immunosuppressed i.non_haem_cancer i.gp_consults i.admissions age1 age2 age3 i.sex i.stp
est store a
qui stcox i.case##i.ethnicity i.imd i.urban i.bmi i.smoking i.ckd_stage i.aki_baseline i.cardiovascular i.diabetes i.hypertension i.immunosuppressed i.non_haem_cancer i.gp_consults i.admissions age1 age2 age3 i.sex i.stp
est store b
qui lrtest b a
