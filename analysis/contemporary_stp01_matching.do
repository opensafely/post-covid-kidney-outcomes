cap log close
log using ./logs/contemporary_stp01_matching, replace t
clear

import delimited ./output/input_contemporary_stp01_matching.csv, delimiter(comma) varnames(1) case(preserve) 
