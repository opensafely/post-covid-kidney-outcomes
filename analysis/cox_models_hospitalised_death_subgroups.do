...
cap log close
macro drop hr
log using ./logs/cox_models_hospitalised_death_subgroups.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cox_models_hospitalised_death_subgroups.csv, write text replace
