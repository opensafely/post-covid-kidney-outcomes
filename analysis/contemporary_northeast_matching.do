cap log close
log using ./logs/contemporary_northeast_matching, replace t
clear

import delimited ./output/input_contemporary_northeast_matching.csv, delimiter(comma) varnames(1) case(preserve) 
