...
#Individuals extracted from study_definition_covid_stp25 will be matched to individuals from 
    #study_definition_contemporary_general_population_stp25
...
match(
    case_csv="covid_stp25_matching",
    match_csv="contemporary_stp25_matching",
    matches_per_case=5,
    match_variables={
        "male": "category",
        "year_of_birth": 0,
