...
cap log close
macro drop hr
log using ./logs/cca_events_covid_severity_death.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cca_events_covid_severity_death.csv, write text replace
