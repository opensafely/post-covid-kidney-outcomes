...
stcox i.covid_severity, vce(cluster set_id) strata(practice_id)
...
stcox i.covid_severity i.sex age1 age2 age3, vce(cluster set_id) strata(practice_id)
matrix table = r(table)
...
stcox i.covid_severity i.sex i.ethnicity i.imd i.urban i.region i.bmi i.smoking age1 age2 age3, vce(cluster set_id) strata(practice_id)
matrix table = r(table)
...
stcox i.covid_severity i.sex i.ethnicity i.imd i.urban i.region i.bmi i.cardiovascular i.diabetes i.hypertension i.immunosuppressed i.non_haem_cancer i.smoking age1 age2 age3, vce(cluster set_id) strata(practice_id)		
matrix table = r(table)
