cap log close
log using ./logs/contemporary_matching_may2021, replace t
clear

import delimited ./output/input_contemporary_matching_may2021.csv, delimiter(comma) varnames(1) case(preserve) 
...
export delimited using "./output/contemporary_matching_may2021.csv", replace
log close
