...
# t1
t1 <- structure(list(
  hr      = c(NA, 1.00, 2.10, 1.41, 1.02, 1.39), 
  lower   = c(NA, 1.00, 2.01, 1.38, 0.99, 1.35),
  upper   = c(NA, 1.00, 2.19, 1.44, 1.06, 1.43),
  number  = c(NA, 10399825, 108275, 1054695, 1042910, 1349535),
  nevents = c("", "79575", "6570", "16335", "5530", "9150"),
  rate   = c(NA, 624, 2815, 883, 480, 863)),
...
tabletext <- cbind(c("AKI", rownames), 
