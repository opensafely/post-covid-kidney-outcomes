...
local lab4: label covid_vax 3
local lab5: label covid_vax 3
...
forvalues vax=1/5 {
	...
	local rate = 100000*(`event'/`person_year')
	file write tablecontent _tab ("`lab`vax''") _tab _tab (`denominator') _tab (`event') _tab %10.0f (`person_year') _tab _tab %3.2f (`rate ') _tab  
