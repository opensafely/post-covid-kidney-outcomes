...
cap log close
macro drop hr
log using ./logs/cox_models2_2017_esrd.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cox_models2_2017_esrd.csv, write text replace
...
stset exit_date`x'_esrd, fail(esrd_date`x') origin(index_date_esrd) id(unique) scale(365.25)
