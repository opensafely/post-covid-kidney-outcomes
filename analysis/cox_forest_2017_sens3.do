...
cap log close
macro drop hr
log using ./logs/cox_forest_2017_sens3.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cox_forest_2017_sens3.csv, write text replace
...
*Sensivity analysis 3 - outcome = ckd4 + eGFR <30
gen egfr30_date=.
