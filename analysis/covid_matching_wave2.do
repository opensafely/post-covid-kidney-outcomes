cap log close
log using ./logs/covid_matching_wave2, replace t
clear

import delimited ./output/input_wave2_covid_matching.csv, delimiter(comma) varnames(1) case(preserve) 
...
export delimited using "./output/wave2_covid_matching.csv", replace
