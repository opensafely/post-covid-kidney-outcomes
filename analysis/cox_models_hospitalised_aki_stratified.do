...
cap log close
macro drop hr
log using ./logs/cox_models_hospitalised_aki_stratified.log, replace t
cap file close tablecontent
file open tablecontent using ./output/cox_models_hospitalised_aki_stratified.csv, write text replace
