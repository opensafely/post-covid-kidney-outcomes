...
cap log close
macro drop hr
log using ./logs/descriptive_pneumonia_ethnicity_2017.log, replace t

cap file close tablecontent
file open tablecontent using ./output/descriptive_pneumonia_ethnicity_2017.csv, write text replace
file write tablecontent _tab ("COVID-19 cohort (n(%))") _tab _tab _tab _tab _tab _tab ("Matched contemporary cohort (n(%))") _tab _tab _tab _tab _tab _tab _n
