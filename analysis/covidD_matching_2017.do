cap log close
log using ./logs/covidD_matching_2017, replace t
clear

import delimited ./output/input_covidD_matching.csv, delimiter(comma) varnames(1) case(preserve) 
...
replace baseline_creatinine_dec2021 = . if !inrange(baseline_creatinine_dec2021, 20, 3000)
gen mgdl_baseline_creatinine_dec2021 = baseline_creatinine_dec2021/88.4
gen min_baseline_creatinine_dec2021=.
replace min_baseline_creatinine_dec2021 = mgdl_baseline_creatinine_dec2021/0.7 if male==0
replace min_baseline_creatinine_dec2021 = mgdl_baseline_creatinine_dec2021/0.9 if male==1
replace min_baseline_creatinine_dec2021 = min_baseline_creatinine_dec2021^-0.329  if male==0
replace min_baseline_creatinine_dec2021 = min_baseline_creatinine_dec2021^-0.411  if male==1
replace min_baseline_creatinine_dec2021 = 1 if min_baseline_creatinine_dec2021<1
gen max_baseline_creatinine_dec2021=.
replace max_baseline_creatinine_dec2021 = mgdl_baseline_creatinine_dec2021/0.7 if male==0
replace max_baseline_creatinine_dec2021 = mgdl_baseline_creatinine_dec2021/0.9 if male==1
replace max_baseline_creatinine_dec2021 = max_baseline_creatinine_dec2021^-1.209
replace max_baseline_creatinine_dec2021 = 1 if max_baseline_creatinine_dec2021>1
gen egfr_baseline_creatinine_dec2021 = min_baseline_creatinine_dec2021*max_baseline_creatinine_dec2021*141
replace egfr_baseline_creatinine_dec2021 = egfr_baseline_creatinine_dec2021*(0.993^age)
replace egfr_baseline_creatinine_dec2021 = egfr_baseline_creatinine_dec2021*1.018 if male==0
...
gen baseline_egfr=.
local month_year "dec2021 jan2022 feb2022 mar2022 apr2022 may2022 jun2022 jul2022 aug2022 sep2022 oct2022"
