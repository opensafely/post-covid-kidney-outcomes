...
cap log close
macro drop hr
log using ./logs/cox_2020_case.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cox_2020_case.txt, write text replace
file write tablecontent ("Kidney outcomes after SARS-CoV-2 infection compared to matched contemporary controls") _n
file write tablecontent _n
file write tablecontent ("general population matched on age, sex and STP") _n
