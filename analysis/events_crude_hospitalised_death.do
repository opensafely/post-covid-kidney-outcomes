...
cap log close
macro drop hr
log using ./logs/events_crude_hospitalised_death.log, replace t

cap file close tablecontent
file open tablecontent using ./output/events_crude_hospitalised_death.csv, write text replace
