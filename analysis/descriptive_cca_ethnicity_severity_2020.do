...
cap log close
macro drop hr
log using ./logs/descriptive_cca_ethnicity_severity_2020.log, replace t

cap file close tablecontent
file open tablecontent using ./output/descriptive_cca_ethnicity_severity_2020.csv, write text replace
...
forvalues i=1/5 {
qui safecount if covid_vax==`vax' & covid_severity==2 & ethnicity==`i'
local cases_`vax'_`i' = round(r(N),5)
local cases_`vax'_pc_`i' = (`cases_`vax'_`i''/`cases_`i'')*100
qui safecount if covid_vax==`vax' & covid_severity==1 & ethnicity==`i'
