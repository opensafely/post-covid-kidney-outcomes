...
cap log close
macro drop hr
log using ./logs/cox_forest_2017_ethnicity_esrd_wave.log, replace t
cap file close tablecontent
file open tablecontent using ./output/cox_forest_2017_ethnicity_esrd_wave.csv, write text replace
...
qui stcox i.wave##i.ethnicity, strata(set_id)
forvalues j=1/4 {
forvalues i=1/5 {
lincom `j'.wave + `j'.wave#`i'.ethnicity, eform
...
qui stcox i.wave##i.ethnicity i.imd i.urban i.bmi i.smoking i.ckd_stage i.aki_baseline i.cardiovascular i.diabetes i.hypertension i.immunosuppressed i.non_haem_cancer i.gp_consults i.admissions, strata(set_id)
forvalues j=1/4 {
forvalues i=1/5 {
lincom `j'.wave + `j'.wave#`i'.ethnicity, eform
local int_`i'`j'b = r(estimate)
