...
cap log close
macro drop hr
log using ./logs/cca_events_cabg_2020.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cca_events_cabg_2020.csv, write text replace
file write tablecontent _tab ("Coronary revascularisation cohort (pre-pandemic)") _tab ("Matched cohort (pre-pandemic)") _n
