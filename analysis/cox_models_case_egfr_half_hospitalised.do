...
cap log close
macro drop hr
log using ./logs/cox_models_case_egfr_half_hospitalised.log, replace t
cap file close tablecontent
file open tablecontent using ./output/cox_models_case_egfr_half_hospitalised.csv, write text replace
