...
cap log close
macro drop hr
log using ./logs/covariates_egfr_half_severity_2017.log, replace t

use ./output/analysis_complete_2017.dta, clear
replace covid_severity=2 if covid_severity==3

cap file close tablecontent
file open tablecontent using ./output/covariates_egfr_half_severity_2017.csv, write text replace
