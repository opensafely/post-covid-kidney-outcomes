...
cap log close
macro drop hr
log using ./logs/cox_models_hospitalised_death_stratified.log, replace t
cap file close tablecontent
file open tablecontent using ./output/cox_models_hospitalised_death_stratified.csv, write text replace
