...
def generate_hospitalised(index_date_variable):
    ...
    critical_care=patients.admitted_to_hospital(
        ...
        return_expectations={"incidence": 0.05, "date": {"earliest" : "index_date", "latest": "index_date + 28 days"}},
    ),
    ...
    death_date=patients.with_death_recorded_in_primary_care(
        between = ["index_date + 29 days", "2022-11-30"],
        returning="date_of_death",
        date_format= "YYYY-MM-DD",
        return_expectations={"incidence": 0.10, "date": {"earliest" : "index_date + 28 days", "latest": "end_date"}},
    ),
    ...
    baseline_creatinine=patients.mean_recorded_value(
        ...
        between=["index_date","index_date - 14 days"],
        return_expectations={
    ...
    krt_outcome_primary_care=patients.with_these_clinical_events(
        ...
        return_expectations={"incidence": 0.05, "date": {"earliest" : "index_date", "latest": "end_date"}}
    ),
    ...
    acute_kidney_injury_outcome=patients.admitted_to_hospital(
        with_these_diagnoses=acute_kidney_injury_codes,
        between = ["index_date + 29 days", "end_date"],
        returning="date_admitted",
        date_format="YYYY-MM-DD",
        find_first_match_in_period=True,    
        return_expectations={"incidence": 0.10, "date": {"earliest" : "index_date + 29 days", "latest": "end_date"}},
    ),
