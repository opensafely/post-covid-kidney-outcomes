cap log close
log using ./logs/covid_matching_may2021, replace t
clear

import delimited ./output/input_covid_matching_may2021.csv, delimiter(comma) varnames(1) case(preserve) 
...
export delimited using "./output/covid_matching_may2021.csv", replace
