...
cap log close
macro drop hr
log using ./logs/cox_forest_2020_ethnicity_wave.log, replace t
cap file close tablecontent
file open tablecontent using ./output/cox_forest_2020_ethnicity_wave.csv, write text replace
file write tablecontent ("outcome") _tab ("wave") _tab ("HR (95% CI)") _tab ("hr") _tab ("ll") _tab ("ul") _tab ("p-value for interaction") _n
...
local int_1ll = r(lb)
local int_1ul = r(ub)
file write tablecontent ("``out'_lab'") _tab ("`wave_`w''") _tab ("`label_1'") _tab %4.2f (`int_1b') (" (") %4.2f (`int_1ll') ("-") %4.2f (`int_1ul') (")") _tab %4.2f (`int_1b') _tab %4.2f (`int_1ll') _tab %4.2f (`int_1ul') _tab %5.4f (`p') _n
forvalues i=2/5 {
lincom 1.case + 1.case#`i'.ethnicity, eform
local int_`i'b = r(estimate)
local int_`i'll = r(lb)
local int_`i'ul = r(ub)
file write tablecontent ("``out'_lab'") _tab ("`wave_`w''") _tab ("`label_`i''") _tab %4.2f (`int_`i'b') (" (") %4.2f (`int_`i'll') ("-") %4.2f (`int_`i'ul') (")") _tab %4.2f (`int_`i'b') _tab %4.2f (`int_`i'll') _tab %4.2f (`int_`i'ul') _n
}
}
}
