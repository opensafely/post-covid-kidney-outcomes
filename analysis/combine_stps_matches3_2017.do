...
* Open a log file
cap log close
log using ./logs/combine_stps_matches3_2017.log, replace t

*(1)=========Change source files to stata format============
foreach i of numlist 5/10 12/17 20/27 29 33 35/37 40/44 49 {
	capture noisily import delimited ./output/matched_matches_2017_3stp`i'.csv, clear
	capture noisily tempfile matched_matches_2017_3stp`i'
	capture noisily save `matched_matches_2017_3stp`i'', replace
}
...
capture noisily export delimited using "./output/input_combined_stps_matches3_2017.csv", replace
