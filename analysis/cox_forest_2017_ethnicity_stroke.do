...
cap log close
macro drop hr
log using ./logs/cox_forest_2017_ethnicity_stroke.log, replace t
cap file close tablecontent
file open tablecontent using ./output/cox_forest_2017_ethnicity_stroke.csv, write text replace
