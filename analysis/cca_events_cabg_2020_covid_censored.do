...
cap log close
macro drop hr
log using ./logs/cca_events_cabg_2020_covid_censored.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cca_events_cabg_2020_covid_censored.csv, write text replace
file write tablecontent _tab ("Coronary revascularisation cohort (pandemic era)") _tab ("Matched cohort (pandemic era)") _n
