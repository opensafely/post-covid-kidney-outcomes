...
cap log close
macro drop hr
log using ./logs/descriptive_asthma_cca_ethnicity_2020.log, replace t

cap file close tablecontent
file open tablecontent using ./output/descriptive_asthma_cca_ethnicity_2020.csv, write text replace
...
qui safecount if case==0 & ethnicity==`i'
...
forvalues i=1/5 {
qui sum follow_up_time_esrd if case==1 & ethnicity==`i', d
local cases_q2_`i' = r(p50)
local cases_q1_`i' = r(p25)
local cases_q3_`i' = r(p75)
qui sum follow_up_time_esrd if case==0 & ethnicity==`i', d
...
forvalues i=1/5 {
qui sum age if case==1 & ethnicity==`i', d
local cases_q2_`i' = r(p50)
local cases_q1_`i' = r(p25)
local cases_q3_`i' = r(p75)
qui sum age if case==0 & ethnicity==`i', d
local controls_q2_`i' = r(p50)
local controls_q1_`i' = r(p25)
local controls_q3_`i' = r(p75)
}
...
forvalues i=1/5 {
qui safecount if agegroup==`age' & case==1 & ethnicity==`i'
local cases_`age'_`i' = round(r(N),5)
local cases_`age'_pc_`i' = (`cases_`age'_`i''/`cases_`i'')*100
qui safecount if agegroup==`age' & case==0 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if sex==`sex' & case==1 & ethnicity==`i'
local cases_`sex'_`i' = round(r(N),5)
local cases_`sex'_pc_`i' = (`cases_`sex'_`i''/`cases_`i'')*100
qui safecount if sex==`sex' & case==0 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if imd==`imd' & case==1 & ethnicity==`i'
local cases_`imd'_`i' = round(r(N),5)
local cases_`imd'_pc_`i' = (`cases_`imd'_`i''/`cases_`i'')*100
qui safecount if imd==`imd' & case==0 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if region==`region' & case==1 & ethnicity==`i'
local cases_`region'_`i' = round(r(N),5)
local cases_`region'_pc_`i' = (`cases_`region'_`i''/`cases_`i'')*100
qui safecount if region==`region' & case==0 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if urban==`urban' & case==1 & ethnicity==`i'
local cases_`urban'_`i' = round(r(N),5)
local cases_`urban'_pc_`i' = (`cases_`urban'_`i''/`cases_`i'')*100
qui safecount if urban==`urban' & case==0 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if bmi==`bmi' & case==1 & ethnicity==`i'
local cases_`bmi'_`i' = round(r(N),5)
local cases_`bmi'_pc_`i' = (`cases_`bmi'_`i''/`cases_`i'')*100
qui safecount if bmi==`bmi' & case==0 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if smoking==`smoking' & case==1 & ethnicity==`i'
local cases_`smoking'_`i' = round(r(N),5)
local cases_`smoking'_pc_`i' = (`cases_`smoking'_`i''/`cases_`i'')*100
qui safecount if smoking==`smoking' & case==0 & ethnicity==`i'
...
forvalues i=1/5 {
qui sum baseline_egfr if case==1 & ethnicity==`i', d
local cases_q2_`i' = r(p50)
local cases_q1_`i' = r(p25)
local cases_q3_`i' = r(p75)
qui sum baseline_egfr if case==0 & ethnicity==`i', d
local controls_q2_`i' = r(p50)
local controls_q1_`i' = r(p25)
local controls_q3_`i' = r(p75)
}
...
forvalues i=1/5 {
qui safecount if egfr_group==`group' & case==1 & ethnicity==`i'
local cases_`group'_`i' = round(r(N),5)
local cases_`group'_pc_`i' = (`cases_`group'_`i''/`cases_`i'')*100
qui safecount if egfr_group==`group' & case==0 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if aki_baseline==1 & case==1 & ethnicity==`i'
local cases_aki_`i' = round(r(N),5)
local cases_aki_pc_`i' = (`cases_aki_`i''/`cases_`i'')*100
qui safecount if aki_baseline==1 & case==0 & ethnicity==`i'
...
forvalues i=1/5 {
qui safecount if diabetes==1 & case==1 & ethnicity==`i'
local cases_diabetes_`i' = round(r(N),5)
local cases_diabetes_pc_`i' = (`cases_diabetes_`i''/`cases_`i'')*100
qui safecount if diabetes==1 & case==0 & ethnicity==`i'
...
forvalues i=1/5 {
qui sum gp_count if case==1 & ethnicity==`i', d
local cases_q2_`i' = r(p50)
local cases_q1_`i' = r(p25)
local cases_q3_`i' = r(p75)
qui sum gp_count if case==0 & ethnicity==`i', d
local controls_q2_`i' = r(p50)
local controls_q1_`i' = r(p25)
local controls_q3_`i' = r(p75)
}
...
file write tablecontent ("`label_`group''") _tab
forvalues i=1/5 {
qui safecount if admissions==`group' & case==1 & ethnicity==`i'
local cases_`group'_`i' = round(r(N),5)
local cases_`group'_pc_`i' = (`cases_`group'_`i''/`cases_`i'')*100
qui safecount if admissions==`group' & case==0 & ethnicity==`i'
local controls_`group'_`i' = round(r(N),5)
local controls_`group'_pc_`i' = (`controls_`group'_`i''/`controls_`i'')*100
}
forvalues i=1/5 {
