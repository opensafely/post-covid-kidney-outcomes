...
cap log close
macro drop hr
log using ./logs/descriptive_cca_asthma_ethnicity_2020.log, replace t

cap file close tablecontent
file open tablecontent using ./output/descriptive_cca_asthma_ethnicity_2020.csv, write text replace
