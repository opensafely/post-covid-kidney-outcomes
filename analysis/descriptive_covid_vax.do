...
cap log close
macro drop hr
log using ./logs/descriptive_covid_vax.log, replace t

cap file close tablecontent
file open tablecontent using ./output/descriptive_covid_vax.csv, write text replace
file write tablecontent _tab ("Pre-pandemic general population comparison") _tab _tab _tab _tab _tab _tab ("Pre-pandemic hospitalised comparison") _n
file write tablecontent _tab ("COVID-19 pre-vaccination") _tab ("COVID-19 1 vaccination dose") _tab ("COVID-19 2 vaccination doses") _tab ("COVID-19 3 vaccination doses") _tab ("COVID-19 4 vaccination doses") _tab ("General population") _tab ("COVID-19 pre-vaccination") _tab ("COVID-19 1 vaccination dose") _tab ("COVID-19 2 vaccination doses") _tab ("COVID-19 3 vaccination doses") _tab ("COVID-19 4 vaccination doses") _tab ("Hospitalised pneumonia") _n
...
forvalues i=1/5 {
qui sum follow_up_time_esrd if covid_vax==`i', d
...
qui sum follow_up_time_esrd if covid_vax==0, d
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if agegroup==`age' & covid_vax==`i'
...
qui safecount if agegroup==`age' & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if sex==`sex' & covid_vax==`i'
...
qui safecount if sex==`sex' & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if imd==`imd' & covid_vax==`i'
...
qui safecount if imd==`imd' & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if ethnicity1==`ethnicity1' & covid_vax==`i'
...
qui safecount if ethnicity1==`ethnicity1' & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if region==`region' & covid_vax==`i'
...
qui safecount if region==`region' & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if urban==1 & covid_vax==`i'
...
qui safecount if urban==1 & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if urban==0 & covid_vax==`i'
...
qui safecount if urban==0 & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if bmi==`bmi' & covid_vax==`i'
...
qui safecount if bmi==`bmi' & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if smoking==`smoking' & covid_vax==`i'
...
qui safecount if smoking==`smoking' & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if smoking==. & covid_vax==`i'
local cases = round(r(N),5)
local cases_pc = (`cases'/`cases`i'_`x'')*100
file write tablecontent %9.0f (`cases') (" (") %4.1f (`cases_pc') (")") _tab
}
qui safecount if smoking==. & covid_vax==0
local controls = round(r(N),5)
local controls_pc = (`controls'/`controls_`x'')*100
file write tablecontent %9.0f (`controls') (" (") %4.1f (`controls_pc') (")") _tab
}
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if egfr_group==`group' & covid_vax==`i'
...
qui safecount if egfr_group==`group' & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if aki_baseline==1 & covid_vax==`i'
...
qui safecount if aki_baseline==1 & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if cardiovascular==1 & covid_vax==`i'
...
qui safecount if cardiovascular==1 & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if diabetes==1 & covid_vax==`i'
...
qui safecount if diabetes==1 & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if hypertension==1 & covid_vax==`i'
...
qui safecount if hypertension==1 & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if immunosuppressed==1 & covid_vax==`i'
...
qui safecount if immunosuppressed==1 & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if non_haem_cancer==1 & covid_vax==`i'
...
qui safecount if non_haem_cancer==1 & covid_vax==0
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui sum gp_count if covid_vax==`i', d
local cases`i'_q2 = r(p50)
local cases`i'_q1 = r(p25)
local cases`i'_q3 = r(p75)
file write tablecontent %3.1f (`cases`i'_q2') (" (") %3.1f (`cases`i'_q1') ("-") %3.1f (`cases`i'_q3') (")") _tab 
}
qui sum gp_count if covid_vax==0, d
local controls_q2 = r(p50)
local controls_q1 = r(p25)
local controls_q3 = r(p75)
file write tablecontent %3.1f (`controls_q2') (" (") %3.1f (`controls_q1') ("-") %3.1f (`controls_q3') (")") _tab
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if gp_consults==`group' & covid_vax==`i'
local cases`i'_`group' = round(r(N),5)
local cases`i'_`group'_pc = (`cases`i'_`group''/`cases`i'_`x'')*100
file write tablecontent %9.0f (`cases`i'_`group'') (" (") %4.1f (`cases`i'_`group'_pc') (")") _tab
}
qui safecount if gp_consults==`group' & covid_vax==0
local controls_`group' = round(r(N),5)
local controls_`group'_pc = (`controls_`group''/`controls_`x'')*100
file write tablecontent %9.0f (`controls_`group'') (" (") %4.1f (`controls_`group'_pc') (")") _tab
}
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui sum hosp_count if covid_vax==`i', d
local cases`i'_q2 = r(p50)
local cases`i'_q1 = r(p25)
local cases`i'_q3 = r(p75)
file write tablecontent %3.1f (`cases`i'_q2') (" (") %3.1f (`cases`i'_q1') ("-") %3.1f (`cases`i'_q3') (")") _tab
}
qui sum hosp_count if covid_vax==0, d
local controls_q2 = r(p50)
local controls_q1 = r(p25)
local controls_q3 = r(p75)
file write tablecontent %3.1f (`controls_q2') (" (") %3.1f (`controls_q1') ("-") %3.1f (`controls_q3') (")") _tab
...
use ./output/analysis_`x'.dta
forvalues i=1/5 {
qui safecount if admissions==`group' & covid_vax==`i'
local cases`i'_`group' = round(r(N),5)
local cases`i'_`group'_pc = (`cases`i'_`group''/`cases`i'_`x'')*100
file write tablecontent %9.0f (`cases`i'_`group'') (" (") %4.1f (`cases`i'_`group'_pc') (")") _tab
}
qui safecount if admissions==`group' & covid_vax==0
local controls_`group' = round(r(N),5)
local controls_`group'_pc = (`controls_`group''/`controls_`x'')*100
file write tablecontent %9.0f (`controls_`group'') (" (") %4.1f (`controls_`group'_pc') (")") _tab
}
