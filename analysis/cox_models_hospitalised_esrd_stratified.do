...
cap log close
macro drop hr
log using ./logs/cox_models_hospitalised_esrd_stratified.log, replace t
cap file close tablecontent
file open tablecontent using ./output/cox_models_hospitalised_esrd_stratified.csv, write text replace
