...
cap log close
macro drop hr
log using ./logs/crude_events_covid_severity_esrd.log, replace t

cap file close tablecontent
file open tablecontent using ./output/crude_events_covid_severity_esrd.csv, write text replace
