...
cap log close
macro drop hr
log using ./logs/descriptive_cabg_ethnicity_2017.log, replace t

cap file close tablecontent
file open tablecontent using ./output/descriptive_cabg_ethnicity_2017.csv, write text replace
