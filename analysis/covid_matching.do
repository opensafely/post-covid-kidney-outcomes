cap log close
log using ./logs/covid_matching, replace t
clear
...
drop if krt_primary_care==1
drop krt_primary_care
drop if krt_icd_10==1
drop krt_icd_10
drop if krt_opcs_4==1
drop krt_opcs_4
...
replace egfr=egfr_creatinine_`x' if  covid_month=="`x'"
drop if egfr <15
