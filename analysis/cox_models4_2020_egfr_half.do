...
cap log close
macro drop hr
log using ./logs/cox_models4_2020_egfr_half.log, replace t

cap file close tablecontent
file open tablecontent using ./output/cox_models4_2020_egfr_half.csv, write text replace
...
qui stcox i.case i.sex i.ethnicity i.imd i.urban i.stp i.region i.bmi i.smoking i.ckd_stage i.aki_baseline i.cardiovascular i.diabetes i.hypertension i.immunosuppressed i.non_haem_cancer i.gp_consults i.admissions i.wave i.covid_vax age1 age2 age3, vce(cluster practice_id)
matrix table = r(table)
...
qui stcox i.covid_severity i.sex i.ethnicity i.imd i.urban i.stp i.region i.bmi i.smoking i.ckd_stage i.aki_baseline i.cardiovascular i.diabetes i.hypertension i.immunosuppressed i.non_haem_cancer i.gp_consults i.admissions i.wave i.covid_vax age1 age2 age3, vce(cluster practice_id)	
matrix table = r(table)
...
qui stcox i.covid_aki i.sex i.ethnicity i.imd i.urban i.stp i.region i.bmi i.smoking i.ckd_stage i.aki_baseline i.cardiovascular i.diabetes i.hypertension i.immunosuppressed i.non_haem_cancer i.gp_consults i.admissions i.wave i.covid_vax age1 age2 age3, vce(cluster practice_id)	
matrix table = r(table)
